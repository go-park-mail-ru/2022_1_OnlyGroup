...
func (handler *AuthHandler) MainAuthHandler(w http.ResponseWriter, r *http.Request) {
	switch r.Method {
	case http.MethodGet:
...
func (handler *AuthHandler) RegisterAuthHandler(w http.ResponseWriter, r *http.Request) {
	switch r.Method {
	case http.MethodPost:
		body, err := io.ReadAll(r.Body)
		defer r.Body.Close()
